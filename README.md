...
The “after” image below was produced from the supplied original portrait by the
real Sunit pipeline with the Natural preset.

| Original | Relighted |
| --- | --- |
| ![Original portrait before relighting](docs/assets/original-portrait.png) | ![Portrait after Sunit relighting](docs/assets/relighted-natural.png) |
...
`0.00000000`; the foreground mean change was `0.01684618`.
...
docs/assets/                  Tracked demo evidence
